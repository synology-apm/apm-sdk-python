"""Unit tests for ExchangeExportCollection: list/start/cancel/get_download_url/get_activity_by_result.

Also covers the shared M365ExportStartResult model and the cross-collection behaviors
(list/get_download_url/get_activity_by_result) parametrized over both ExchangeExportCollection
and GroupExportCollection. GroupExportCollection-only scenarios live in
test_m365_mail_export_group.py.
"""
...
# ── ExchangeExportCollection tests (continued) ────────────────────────────
